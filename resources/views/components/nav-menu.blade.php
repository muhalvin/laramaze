        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <x-nav-item-2 :active="request()->routeIs('components.*')">
                    ...
                    <x-nav-submenu :active="request()->routeIs('components')">
                        <x-nav-sublink :active="request()->routeIs('components')" :href="route('components')">
                            Components
                        </x-nav-sublink>
                    </x-nav-submenu>
                </x-nav-item-2>
                ...
                <x-nav-item-2 :active="request()->routeIs('pages.*')">
                    <a href="#" class="sidebar-link">
                        <i class="bi bi-stack"></i>
                        <span>Pages</span>
                    </a>

                    <x-nav-submenu :active="request()->routeIs('pages')">
                        <x-nav-sublink :active="request()->routeIs('pages.1')" :href="route('pages.1')">
                            Pages 1
                        </x-nav-sublink>

                        <x-nav-sublink :active="request()->routeIs('pages.2')" :href="route('pages.2')">
                            Pages 2
                        </x-nav-sublink>
                    </x-nav-submenu>
                </x-nav-item-2>
